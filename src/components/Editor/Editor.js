  ...
  const workExpBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        ...
        <InputControl
          label="Company Name"
          placeholder="Enter company name eg. Adobe"
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Title"
          value={values.title}
          placeholder="Enter title eg. Chatting app"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Kushagra Saxena"
          value={values.name}
          onChange={(event) =>
  ...
  const summaryBody = (
    <div className={styles.detail}>
      <InputControl
        ...
        placeholder="Enter your career objective/summary"
        onChange={(event) =>
...
//                 <InputControl
//                    label="College Name"
//                    placeholder="Enter college name eg. IIT Kanpur"
//                    value= {values.college}
...
//                 <InputControl
//                    label="Name"
//                    placeholder="Enter your full name eg. Rohit Sharma"
//                    value= {values.name}
...
//                 break;
//     }
//     // console.log('handleSubmission - Updated Information:', information);
// };
...
//             endDate: activeInfo?.details ? activeInfo.details[0]?.endDate || "": "",
//             points: activeInfo?.details 
//                 ? activeInfo.details[0]?.points ? [...activeInfo.details[0]?.points] : "" 
//                 : activeInfo?.points? [...activeInfo.points] : "",
//             summary:typeof activeInfo?.detail !== "object" ?activeInfo.detail:"",
//             other: typeof activeInfo?.detail !== "object" ?activeInfo.detail:"",
//         });
//         // console.log('useEffect - Active Information:', activeInfo);
//     }, [activeSectionKey, information, sections]);

//     useEffect(()=>{
//         setActiveInformation(information[sections[activeSectionKey]]);
//         // console.log('useEffect - Updated Active Information:', information[sections[activeSectionKey]]);
//     }, [activeSectionKey, information, sections]);
...
//              key={key} onClick={() => setActiveSectionKey(key)}>
//              {sections[key]}
//             </div>)}
//         </div>
//         <div className= {styles.body}>
...
//             </div>
//             {generateBody()}
//             <button onClick={handleSubmission} onClick={handleAddNew}>Save</button>
//         </div>
//     </div>;
// };
